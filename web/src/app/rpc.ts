...
export const fetchData = (url: string, method: HttpMethod, body?: unknown, headers?: Record<string, string>) => sendMessage("fetchData", [url, method, body, headers || {}], {log_rpc: true})
